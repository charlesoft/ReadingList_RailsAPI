...
class CreatingBooksTest < ActionDispatch::IntegrationTest
  test 'create news books with valid data' do
    post '/books',{ book: { title: 'Pragmatic Programmer', rating: '5',
        author: 'Dave Thomas',
        genre_id: 1,
        review: 'Excellent for any programmer.',
        amazon_id: '13123'}
      }.to_json ,
    ...
    assert_equal 'Excellent for any programmer.', book[:review]
